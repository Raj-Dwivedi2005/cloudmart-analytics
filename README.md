...
Access the interactive production demo dashboard here:

👉 **[Launch CloudMart Live Executive Dashboard](https://cloudmart-analytics.streamlit.app)**

*(Note: The live Streamlit app runs off a static Parquet snapshot generated by the pipeline, with an offline Bedrock fallback so it requires zero active AWS billable endpoints to view!)*
